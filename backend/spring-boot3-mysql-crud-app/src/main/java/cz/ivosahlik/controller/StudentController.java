...
import cz.ivosahlik.exception.ResourceNotFoundException;
...
public class StudentController {
    ...
    public ResponseEntity<Student> updateStudent(@PathVariable(value = "id") Long id, @RequestBody Student studentDto)
        ...
        extracted(id, studentDto, student);
        final Student updateStudent = studentRepository.save(student);
        return ResponseEntity.ok(updateStudent);
    }

    private static void extracted(Long id, Student studentDto, Student student) {
    ...
    public ResponseEntity<Boolean> deleteStudent(@PathVariable(value = "id") Long id) throws ResourceNotFoundException {
        Student student = studentRepository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException
                        ("Student not found for this id :: " + id));
